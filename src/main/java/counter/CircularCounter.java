 ...
 * 原文：https://blog.csdn.net/nmgrd/article/details/77015206 
 * 前几天工作中一段业务代码需要一个变量每天从1开始递增。为此自己简单的封装了一个线程安全的计数器，可以让一个变量每天从1开始递增。
 * 当然了，如果项目在运行中发生重启，即便日期还是当天，还是会从1开始重新计数。
 * 所以把计数器的值存储在数据库中会更靠谱，不过这不影响这段代码的价值，现在贴出来，供有需要的人参考。
 */
